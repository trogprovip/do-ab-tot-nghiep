  ...
  const columns = [
    ...
    },
    {
      ...
      render: (value: any, row: Ticket) => {
        ...
        const price = row.final_amount
          ? Number(row.final_amount).toLocaleString("vi-VN")
          : "0";
          ...
          {editingTicketId === row.id ? (
            ...
            <>
              <button
                ...
                className="px-2 py-1 text-green-600 hover:text-green-700 hover:bg-blue-50 rounded"
                title="Sửa"
              >
                {/* 2. Thay thế chữ "Sửa" bằng icon SquarePen */}
        ...
        <div className="fixed inset-0 bg-white/30 backdrop-blur-md flex items-center justify-center z-50">
          <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6 space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="font-medium text-gray-900">
                      {selectedTicket.tickets_code}
                    </p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-600">Ngày đặt vé</p>
                    <p className="font-medium text-gray-900">
                      {selectedTicket.tickets_date
                        ? new Date(
                            selectedTicket.tickets_date
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-gray-900">
                        {selectedTicket.slots?.show_time
                          ? new Date(
                              selectedTicket.slots.show_time
              ...
              {selectedTicket.bookingseats &&
                selectedTicket.bookingseats.length > 0 && (
                      ...
                      {selectedTicket.bookingseats.map((bookingSeat) => (
                        ...
                        >
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <p className="font-medium text-gray-900">
                                Ghế {bookingSeat.seats.seat_number}
                              </p>
              ...
              {selectedTicket.ticketsdetails &&
                selectedTicket.ticketsdetails.length > 0 && (
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <div className="mt-1">
                        ...
                        >
                          {paymentStatusMap[selectedTicket.payment_status] ||
