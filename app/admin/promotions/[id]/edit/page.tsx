  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        {/* Applicable Items */}
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <h2 className="text-xl font-semibold text-gray-900 mb-6">Phạm vi áp dụng</h2>
            ...
            <div>
              ...
              <div className="flex gap-2 mb-2">
                <input
                  ...
                  onKeyPress={(e) => e.key === 'Enter' && (e.preventDefault(), addMovie())}
              ...
              <div className="flex flex-wrap gap-2">
                {formData.applicable_movies.map((movie) => (
                  <span
                    key={movie}
            ...
            <div>
              ...
              <div className="flex gap-2 mb-2">
                <input
                  ...
                  onKeyPress={(e) => e.key === 'Enter' && (e.preventDefault(), addCinema())}
                  className="flex-1 px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  placeholder="Nhập tên rạp và nhấn Enter"
                />
                <button
                  type="button"
                  onClick={addCinema}
              ...
              <div className="flex flex-wrap gap-2">
                {formData.applicable_cinemas.map((cinema) => (
                  <span
                    key={cinema}
